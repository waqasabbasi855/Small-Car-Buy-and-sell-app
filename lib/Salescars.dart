...
class salescars extends StatefulWidget
{
  @override
...
class sale extends State<salescars>
...
Widget build(BuildContext context) {
  ...
  return Scaffold(appBar: AppBar(backgroundColor: Colors.blue.shade200,title: Text("SalesCars",style: TextStyle(color: Colors.white),),),
              ...
              child: Padding(padding: EdgeInsets.all(6),
                child: Container(
                  decoration: BoxDecoration(
                      color: Colors.red.shade300,borderRadius: BorderRadius.circular(12),image: DecorationImage(image:AssetImage("assets/images/salescars.jpg"),fit:BoxFit.fill )),height: 200,width: 800,
                ),
              ),
            ),
          ),
